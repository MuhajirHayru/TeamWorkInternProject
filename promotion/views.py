...
from .models import  Media,JobAnnouncement,News,Event,brand,service,Product,CompetitionDetail
...
#i want to develop api for news here 
from .serializers import NewsSerializer
class NewsCreation(generics.CreateAPIView):
    serializer_class=NewsSerializer
class Newssposted(ListAPIView):
